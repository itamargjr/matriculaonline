...
public class DSReportCandidatoClass implements JRDataSource {
	
	private Iterator<Edu_matr_candidatoReport> dados;
	
	private Edu_matr_candidatoReport registro;
	
	private Edu_escolas_modensinovagas vaga;
	
	public DSReportCandidatoClass(List<Edu_matr_candidatoReport> lista, Edu_escolas_modensinovagas v) {
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		if(field.getName().equalsIgnoreCase("nomeescolaclass")){
			return vaga.getNome_escola();
		}
		
		if(field.getName().equalsIgnoreCase("descricao_modensinoanosclass")){
			return vaga.getDescricao_modensinoanos();
		}
		
		if(field.getName().equalsIgnoreCase("descricao_modensinoclass")){
			return vaga.getDescricao_modensino();
		}
